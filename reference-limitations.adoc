...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Scopri come utilizzare il backup cloud per eseguire il backup e il ripristino dei dati ONTAP"^].
